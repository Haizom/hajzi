...
const REVIEWS = [
  {
    id: 1,
    userAr: 'أحمد العمري',
    userEn: 'Ahmed Al-Amri',
    rating: 5,
    dateAr: 'قبل 3 أيام',
    dateEn: '3 days ago',
    commentAr: 'شقة رائعة! نظيفة جداً ومريحة. الموقع ممتاز والخدمات متكاملة. سأعود بالتأكيد.',
    commentEn: 'Amazing apartment! Very clean and comfortable. Excellent location and comprehensive services. Will definitely come back.',
    helpful: 15,
    notHelpful: 1,
  },
  {
    ...
    dateAr: 'قبل أسبوع',
    dateEn: '1 week ago',
    commentAr: 'شقة جميلة وموقع مميز. المطبخ مجهز بالكامل والأثاث مريح. الخدمة ممتازة.',
    commentEn: 'Beautiful apartment and prime location. Fully equipped kitchen and comfortable furniture. Excellent service.',
    helpful: 12,
    notHelpful: 2,
  },
  {
    id: 3,
    userAr: 'محمد السقاف',
    userEn: 'Mohammed Al-Saqqaf',
    rating: 4.8,
    dateAr: 'قبل شهر',
    dateEn: '1 month ago',
    commentAr: 'إقامة لا تنسى! الشقة نظيفة ومرتبة والموظفين متعاونين جداً. سأوصي بها لأصدقائي.',
    commentEn: 'Unforgettable stay! Clean and tidy apartment, very cooperative staff. Will recommend to my friends.',
    helpful: 18,
    notHelpful: 0,
  },
];
...
export function ApartmentReviews({ apartment }: ReviewsProps) {
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <div className="text-center">
            <div className="relative">
              <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-md">
                <div>
                  <div className="text-3xl font-bold text-primary-600">{apartment.rating}</div>
                  <div className="text-sm font-medium text-primary-800">
                    {getRatingLabel(apartment.rating)}
                  </div>
                </div>
              </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-3">
            {[
              { 
                icon: Smile, 
                label: { ar: 'رضا النزلاء', en: 'Guest Satisfaction' }, 
                value: 95 
              },
              { 
                icon: CheckCircle2, 
            ...
            <form onSubmit={handleSubmitReview} className="p-4 space-y-4">
              ...
              <div className="text-center">
                <label className="block text-sm font-medium text-gray-900 mb-2">
                  {language === 'ar' ? 'ما هو تقييمك؟' : 'How would you rate your stay?'}
                </label>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={language === 'ar' 
                    ? 'شارك تجربتك مع الشقة...'
                    : 'Share your experience with the apartment...'
                  }
                />
              </div>
