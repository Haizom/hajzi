...
const PROPERTY_TYPES = [
  { id: 'chalet', labelAr: 'شاليه', labelEn: 'Chalet' },
  { id: 'rest-house', labelAr: 'استراحة', labelEn: 'Rest House' },
];
...
export function ChaletsFilters({ filters, setFilters, showFilters, setShowFilters }: FiltersProps) {
  ...
  const handleTypeChange = (type: 'chalet' | 'rest-house' | null) => {
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            placeholder={language === 'ar' ? 'ابحث عن شاليه أو استراحة...' : 'Search for a chalet or rest house...'}
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {PROPERTY_TYPES.map((type) => (
            <button
              key={type.id}
              onClick={() => handleTypeChange(type.id as 'chalet' | 'rest-house')}
