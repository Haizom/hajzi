...
export function TermanahHeader({ 
  termanah, 
  images, 
  selectedImage, 
  setSelectedImage, 
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 mb-2">
            <div className="flex items-center gap-1">
              ...
              <span className="font-medium">{termanah.rating}</span>
            </div>
            <div className="flex items-center gap-1 text-gray-600">
              <MapPin className="w-5 h-5" />
              <span>{language === 'ar' ? termanah.locationAr : termanah.locationEn}</span>
            </div>
            <div className="flex items-center gap-1 text-gray-600">
              <Users className="w-5 h-5" />
              <span>{termanah.capacity} {language === 'ar' ? 'شخص' : 'people'}</span>
            </div>
          </div>
          ...
          <div className="text-gray-600">
            {language === 'ar' 
              ? 'صنعاء القديمة - السايلة - أمام مسجد النور'
              : 'Old Sanaa - Al-Sailah - In front of Al-Noor Mosque'
            }
          </div>
        </div>
