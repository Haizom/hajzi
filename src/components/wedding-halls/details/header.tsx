...
type HeaderProps = {
  ...
  selectedTab: 'overview' | 'booking' | 'reviews' | 'policies';
  setSelectedTab: (tab: 'overview' | 'booking' | 'reviews' | 'policies') => void;
};
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-1 text-gray-600">
                ...
                <span>{language === 'ar' ? hall.locationAr : hall.locationEn}</span>
              </div>
            </div>
            <div className="text-gray-600">
              {language === 'ar' ? hall.addressAr : hall.addressEn}
            </div>
          </div>
        </div>
