...
const REVIEWS = [
  {
    ...
    dateAr: 'قبل 3 أيام',
    dateEn: '3 days ago',
    commentAr: 'قاعة رائعة! المكان نظيف جداً والخدمة ممتازة. نظام الصوت ممتاز والديكور جميل.',
    commentEn: 'Amazing hall! Very clean place and excellent service. Great sound system and beautiful decoration.',
    helpful: 15,
    notHelpful: 1,
  },
  {
    ...
    dateAr: 'قبل أسبوع',
    dateEn: '1 week ago',
    commentAr: 'قاعة جميلة وخدمة ممتازة. الضيافة كانت رائعة والموظفين متعاونين.',
    commentEn: 'Beautiful hall and excellent service. The hospitality was great and the staff were cooperative.',
    helpful: 12,
    notHelpful: 2,
  },
];
...
export function HallReviews({ hall }: ReviewsProps) {
          ...
          <div className="text-center">
            <div className="relative">
              <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-md">
                <div>
                  <div className="text-3xl font-bold text-primary-600">{hall.rating}</div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={language === 'ar' 
                    ? 'شارك تجربتك مع القاعة...'
                    : 'Share your experience with the hall...'
                  }
                />
              </div>
