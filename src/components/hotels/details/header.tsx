...
type HeaderProps = {
  ...
  selectedTab: 'overview' | 'rooms' | 'reviews' | 'policies';
  setSelectedTab: (tab: 'overview' | 'rooms' | 'reviews' | 'policies') => void;
};
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-1 text-gray-600">
                ...
                <span>{language === 'ar' ? hotel.locationAr : hotel.locationEn}</span>
              </div>
            </div>
            <div className="text-gray-600">
              {language === 'ar' ? hotel.addressAr : hotel.addressEn}
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          <div className="flex overflow-x-auto whitespace-nowrap gap-2">
            {[
              ...
              { id: 'rooms', labelAr: 'الغرف', labelEn: 'Rooms' },
