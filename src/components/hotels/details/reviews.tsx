...
export function HotelReviews({ hotel }: ReviewsProps) {
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <div className="text-center">
            <div className="relative">
              <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-md">
                <div>
                  <div className="text-3xl font-bold text-primary-600">{hotel.rating}</div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-3">
            {[
              { 
                icon: Smile, 
                label: { ar: 'رضا الضيوف', en: 'Guest Satisfaction' }, 
                value: 95 
              },
              { 
                icon: CheckCircle2, 
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={language === 'ar' 
                    ? 'شارك تجربتك مع الفندق...'
                    : 'Share your experience with the hotel...'
                  }
                />
              </div>
